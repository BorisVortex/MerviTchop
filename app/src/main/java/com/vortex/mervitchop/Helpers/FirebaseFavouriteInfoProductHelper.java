package com.vortex.mervitchop.Helpers;
...
public class FirebaseFavouriteInfoProductHelper {
    ...
    public void readFavourite(String productId,String userId,final DataStatus dataStatus)
    {
    ...
    public void addFavourite(String userId,String productId, final DataStatus dataStatus)
    {
    ...
    public void removeFavourite(String userId,String productId, final DataStatus dataStatus)
    {
