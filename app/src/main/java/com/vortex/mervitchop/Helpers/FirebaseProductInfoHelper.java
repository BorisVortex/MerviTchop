...
public class FirebaseProductInfoHelper {
    ...
    public void countFavourite(final DataStatusCountFavourite dataStatusCountFavourite)
    {
    ...
    public void readInformationById(final DataStatusInformationOfProduct dataStatusInformationOfProduct)
    {
